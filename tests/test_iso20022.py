...
def test_parse_camt053() -> None:
    ...
    config = {"iban": "CHxxxxxxxxxxxxxxxxxxx", "currency": "CHF"}
    parser = plugin.get_parser(os.path.join(SAMPLES_DIR, "camt053.001.04.xml"))
    ...
    config = {"iban": "CHxxxxxxxxxxxxxxxxxxx"}
    parser = plugin.get_parser(os.path.join(SAMPLES_DIR, "CAMT053_300623_anonymized.xml"))
